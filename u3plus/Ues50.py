...
class UesNet(nn.Module):
    def __init__(self, n_class=21):
        ...
        self.layer0 = nn.Sequential(*self.base_layers[:3])  # e.g., (N, 64, x.H/2, x.W/2)
        self.layer0_1x1 = convrelu(64, 64, 1, 0)

        self.layer1 = nn.Sequential(*self.base_layers[3:5])  # e.g., (N, 256, x.H/4, x.W/4)
        self.layer1_1x1 = convrelu(256, 256, 1, 0)

        self.layer2 = self.base_layers[5]  # e.g., (N, 512, x.H/8, x.W/8)
        self.layer2_1x1 = convrelu(512, 512, 1, 0)

        self.layer3 = self.base_layers[6]  # e.g., (N, 1024, x.H/16, x.W/16)
        self.layer3_1x1 = convrelu(1024, 1024, 1, 0)

        self.layer4 = self.base_layers[7]  # e.g., (N, 2048, x.H/32, x.W/32)
